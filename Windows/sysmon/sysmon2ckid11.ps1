...
$events = Get-WinEvent  -FilterHashtable @{ logname = "Microsoft-Windows-Sysmon/Operational"; Id = 11;StartTime=(get-date).AddMinutes(-10) } -erroraction silentlycontinue
$guid = New-Guid
...
foreach ($event in $events)
{
    ...
    $o.ProcessId+','+$o.Image+','+$o.TargetFilename+','+$o.CreationUtcTime+','+$o.User
